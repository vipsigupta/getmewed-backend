...
export declare class FeedService {
    ...
    getFeed(spaceId: string, cursor?: string, limit?: number): Promise<{
        posts: ({
            guest: {
                id: string;
                name: string;
    ...
    removeReaction(feedPostId: string, guestId: string, emoji: string): Promise<{
        removed: boolean;
    }>;
    private getReactionCounts;
    ...
    getComments(feedPostId: string, limit?: number): Promise<({
        guest: {
            id: string;
            name: string;
            profileUrl: string | null;
